...
function surpriseHandler() {
  let promptValue = confirm(
    'BABY ,IDHI NA FIRST PROJECT(chinnadhe but start to end motham neney chesa) Chusi cheppu I Love You. Jagartha hospital lo,ee tym lo kuda chusthunandhuku Thank you Prathyamma'
  );
  if (promptValue == true) {
